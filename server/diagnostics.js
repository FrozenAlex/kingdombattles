...
const logDiagnostics = (name, quantity) => {
	let query = 'INSERT INTO diagnosticsEvents (eventName, quantity) VALUES (?, ?);';
	pool.query(query, [name, quantity], (err) => {
		if (err) throw err;
	});
};
